...
public class Civic implements Vehicle {
	...
	public Civic(long engineNo, String registrationNo) {
		System.out.println("Manufacturing Civic Car....");
		System.out.println("Manufacturing Completed.");
		this.engineNo = engineNo;
		System.out.println("Engine No: " + engineNo);
		System.out.println("Registering Civic Car...");
	...
	@Override
	public void start() {
		System.out.println("Starting Civic Car...");
	}

	@Override
	public void stop() {
		System.out.println("Switching off Civic Car...");
	}
